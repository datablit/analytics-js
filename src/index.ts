...
class Analytics {
    ...
    private endpoint = "http://api.datablit.com/v1/batch";
    private writeKey = ""
    ...
    private flush(): void {
        ...
        fetch(this.endpoint, {
            method: "POST",
            headers: { "Content-Type": "application/json", "write_key": this.writeKey },
    ...
    private saveQueue(): void {
        if (this.queue.length > 100) { // If backend is down we should avoid adding lots of events in localstorage 
            return
        }
